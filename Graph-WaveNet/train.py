...
parser.add_argument('--aptonly',action='store_false',help='whether only adaptive adj')
...
parser.add_argument('--save',type=str,default='./garage/metrtestusesupport2',help='save path')
